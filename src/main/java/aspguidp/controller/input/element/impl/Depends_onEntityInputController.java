...
import aspguidp.service.input.Depends_onEntityDataServicePool;
 ...
 */
public class Depends_onEntityInputController extends EntityInputController {
    @FXML
    ...
    protected void initialize() {
        DataServicePool dataServicePool = Depends_onEntityDataServicePool.getInstance();
        int inputCountMin = 0;
