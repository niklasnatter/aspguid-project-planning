 ...
 */
public class Project_managementMax_employee_countValueDataServicePool extends DataServicePool {
    private static Project_managementMax_employee_countValueDataServicePool instance;
    ...
    private Project_managementMax_employee_countValueDataServicePool() {}

    /**
     * @return singleton service pool instance of this class
     */
    public static Project_managementMax_employee_countValueDataServicePool getInstance() {
        if (instance == null) {
            instance = new Project_managementMax_employee_countValueDataServicePool();
        }
        return instance;
    }
    ...
    private Map<String, AttributeDefinition> getAttributeDefinitionMap() {
        if (this.attributeDefinitionMap == null) {
            ...
            this.attributeDefinitionMap.put("max_employee_count", new AttributeDefinition("max_employee_count", "number", "#int"));
        }
