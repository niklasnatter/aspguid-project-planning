 ...
 */
public class Planned_taskEntityDataServicePool extends DataServicePool {
    private static Planned_taskEntityDataServicePool instance;
    ...
    private Planned_taskEntityDataServicePool() {}

    /**
     * @return singleton service pool instance of this class
     */
    public static Planned_taskEntityDataServicePool getInstance() {
        if (instance == null) {
            instance = new Planned_taskEntityDataServicePool();
        }
        return instance;
    }
    ...
    private Map<String, AttributeDefinition> getAttributeDefinitionMap() {
        if (this.attributeDefinitionMap == null) {
            ...
            this.attributeDefinitionMap.put("start", new AttributeDefinition("start", "start", ""));
            this.attributeDefinitionMap.put("end", new AttributeDefinition("end", "end", ""));
        }
    ...
    public List<TemplatePart> getAtomTemplateParts() {
        if (this.atomTemplateTemplateParts == null) {
            this.atomTemplateTemplateParts = TemplateHelper.getTemplateParts(
                    "planned_task(::task_name,::start,::end)",
                    s -> this.getAttributeDefinitionMap().get(s).getName(),
                    s -> this.getAttributeDefinitionMap().get(s).getValueSource()
            );
        }
