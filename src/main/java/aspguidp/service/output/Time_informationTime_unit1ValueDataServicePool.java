 ...
 */
public class Time_informationTime_unit1ValueDataServicePool extends DataServicePool {
    private static Time_informationTime_unit1ValueDataServicePool instance;
    ...
    private Time_informationTime_unit1ValueDataServicePool() {}

    /**
     * @return singleton service pool instance of this class
     */
    public static Time_informationTime_unit1ValueDataServicePool getInstance() {
        if (instance == null) {
            instance = new Time_informationTime_unit1ValueDataServicePool();
        }
        return instance;
    }
    ...
    private Map<String, AttributeDefinition> getAttributeDefinitionMap() {
        if (this.attributeDefinitionMap == null) {
            ...
            this.attributeDefinitionMap.put("time_unit1", new AttributeDefinition("time_unit1", "time_unit1", ""));
        }
