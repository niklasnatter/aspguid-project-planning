 ...
 */
public class Time_informationProject_durationValueDataServicePool extends DataServicePool {
    private static Time_informationProject_durationValueDataServicePool instance;
    ...
    private Time_informationProject_durationValueDataServicePool() {}

    /**
     * @return singleton service pool instance of this class
     */
    public static Time_informationProject_durationValueDataServicePool getInstance() {
        if (instance == null) {
            instance = new Time_informationProject_durationValueDataServicePool();
        }
        return instance;
    }
    ...
    private Map<String, AttributeDefinition> getAttributeDefinitionMap() {
        if (this.attributeDefinitionMap == null) {
            ...
            this.attributeDefinitionMap.put("project_duration", new AttributeDefinition("project_duration", "project_duration", ""));
        }
