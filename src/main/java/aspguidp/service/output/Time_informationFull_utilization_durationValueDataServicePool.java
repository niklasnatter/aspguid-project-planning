 ...
 */
public class Time_informationFull_utilization_durationValueDataServicePool extends DataServicePool {
    private static Time_informationFull_utilization_durationValueDataServicePool instance;
    ...
    private Time_informationFull_utilization_durationValueDataServicePool() {}

    /**
     * @return singleton service pool instance of this class
     */
    public static Time_informationFull_utilization_durationValueDataServicePool getInstance() {
        if (instance == null) {
            instance = new Time_informationFull_utilization_durationValueDataServicePool();
        }
        return instance;
    }
    ...
    private Map<String, AttributeDefinition> getAttributeDefinitionMap() {
        if (this.attributeDefinitionMap == null) {
            ...
            this.attributeDefinitionMap.put("full_utilization_duration", new AttributeDefinition("full_utilization_duration", "full_utilization_duration", ""));
        }
    ...
    public List<TemplatePart> getAtomTemplateParts() {
        if (this.atomTemplateTemplateParts == null) {
            this.atomTemplateTemplateParts = TemplateHelper.getTemplateParts(
                    "full_utilization_duration(::full_utilization_duration)",
                    s -> this.getAttributeDefinitionMap().get(s).getName(),
                    s -> this.getAttributeDefinitionMap().get(s).getValueSource()
            );
        }
